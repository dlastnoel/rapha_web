...
urlpatterns = [
    ...
    path('doctor/schedule/', views.viewSchedule, name='schedule'),
    path('doctor/schedule/<str:pk>', views.editSchedule, name='edit-schedule'),
    path('doctor/reset-schedule/<str:pk>',
         views.resetSchedule, name='reset-schedule'),
